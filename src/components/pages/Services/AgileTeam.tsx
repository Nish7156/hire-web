            ...
            <div className="">
              <div className=" flex justify-center gap-4 flex-col md:flex-row">
                <div className=" mt-[92px]">
                  <img src="/images/agile-team-1.svg" className="w-full md:w-auto" alt="" />
                </div>
                <div className="">
                  <img src="/images/agile-team-2.svg" className="w-full md:w-auto" alt="" />
                </div>
                <div className="mt-[56px]">
                  <img src="/images/agile-team-3.svg" className="w-full md:w-auto" alt="" />
                </div>
              </div>
            </div>
          </div>
